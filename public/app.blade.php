...
<meta name="google-site-verification" content="5xPweYjn0VmqpNaz0pvkFRDSS-GMn46O8tkDCnnqF8M" />

	<title>Фотограф Іван Шумик</title>
	
	<title>Фотограф на весілля львів</title>
	
	<title>Фотограф львів</title>
		<title>Фотограф на свадьбу</title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-114432214-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-114432214-1');
</script>
